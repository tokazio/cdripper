...
public class Player {
    ...
    public void play(String f) throws DecodeException {
        play(f, 0);
    }

    public void play(String f, int off) throws DecodeException {
        ...
        try {
            ...
            throw new DecodeException("Not found " + f, e);
        } catch (LineUnavailableException e) {
            throw new DecodeException("Can't play this format", e);
        }
        decoder.dispose();
