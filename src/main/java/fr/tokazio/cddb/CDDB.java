...
public class CDDB implements Closeable {
     ...
     * @throws IOException   Thrown if a network error occurs attempting to connect to the host.
     * @throws CDDBException Thrown if an error occurs after identifying ourselves to the host.
     * @see #STANDARD_PORT
     * @see #close
     */
    ...
    public static class Entry {
         ...
         *
         * @throws CDDBException Thrown if the entry is not properly formatted.
         */
